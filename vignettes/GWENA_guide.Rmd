...
res_net <- build_net(kuehne_expr_filtered, cor_func = "spearman", detailled_result = TRUE)
```
...
```{r modules_detection}
detection <- modules_detection(kuehne_expr_filtered, res_net$net, merge_cut_height = 0.997, detailled_result = TRUE)
```
